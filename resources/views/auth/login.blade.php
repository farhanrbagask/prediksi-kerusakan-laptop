        ...
        <div class="relative z-10 min-h-full flex items-center justify-center p-6">
            <div class="glass-card rounded-3xl p-8 md:p-12 max-w-sm w-full">
                ...
                <div class="fade-in text-center mb-8">
                    <div
                        class="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center shadow-lg mb-4" style="background: linear-gradient(135deg, #0d9488 0%, #065f46 100%); box-shadow: 0 8px 25px -5px rgba(13, 148, 136, 0.5);">
                ...
                <div class="fade-in fade-in-delay-2 mt-6 space-y-4">
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}"
                            class="block text-center text-sm text-teal-300 hover:text-teal-200 transition-colors">
                            Lupa Password?
                        </a>
                    @endif
                    ...
                    <p class="text-center text-gray-300">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="text-teal-300 hover:text-teal-200 font-semibold transition-colors">
                                Daftar Sekarang
                            </a>
                        @endif
                    </p>
